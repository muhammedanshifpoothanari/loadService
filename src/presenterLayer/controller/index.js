...
const { getAllByWareHouseIdCntrl: getAllByWareHouseIdController } = require('./common/getAllByWareHouseId.controller');
const { getAllByWeightCntrl: getAllByWeightController } = require('./common/getAllByWeight.controller');
const { getByLoadIdCntrl: getByLoadIdController } = require('./common/getById.controller');
...
module.exports = {
    ...
    getAllByWareHouseIdController,
    getAllByWeightController,
    getByLoadIdController,
    blockByIdController,
